...
def custom_study_b():
    ...
    _ta = [{"kind": "ema", "params": (5,)}, {"kind": "fisher", "params": (13, 7)}]  # 1  # 2
    return ta.Study(name="Custom Args Tuple", ta=_ta, description="Allow for easy filling in indicator arguments by argument placement")
...
def custom_study_c():
    ...
    return ta.Study(name="Custom Col Numbers Tuple", ta=[{"kind": "bbands", "col_names": ("LB", "MB", "UB", "BW", "BP")}], description="Allow for easy renaming of resultant columns")
...
def custom_study_d():
    ...
    return ta.Study(
        ...
        ta=[{"kind": "macd", "col_numbers": (1,)}, {"kind": "bbands", "col_numbers": (0, 2)}],  # macd histogram  # bbands lower and upper
...
def custom_study_e():
    ...
    _ta = [{"kind": "amat", "fast": 20, "slow": 50}, {"kind": "log_return", "cumulative": True}, {"kind": "ema", "close": "CUMLOGRET_1", "length": 5}]  # 2  # 1  # 1

    return ta.Study(name="AMAT Log Returns", ta=_ta, cores=0, description="AMAT Log Returns")
